...
public class TestLotteryNumberStatisticsHw {
	...
	public void printResult() {
		for (int k = 0; k < count.length; k++) {
			System.out.printf("%2d:%4d %2d:%4d %2d:%4d %2d:%4d %2d:%4d %2d:%4d\n", number[k], count[k], number[k], count[k], number[k], count[k], number[k], count[k], number[k], count[k], number[k], count[k]);
		}
	}
